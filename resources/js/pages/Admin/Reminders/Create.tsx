...
export default function Create({ cars }: Props) {
    ...
    return (
        <>
            <Head title="Tambah Pengingat" />
            <AdminLayout>
                <main className="flex-1 space-y-6 p-8">
                    <div className="flex items-center justify-between gap-4">
                        <h1 className="text-2xl font-semibold">Tambah Pengingat</h1>
                        <Link
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div>
                                <label htmlFor="due_date" className="mb-1 block text-sm font-medium">Tanggal Jatuh Tempo</label>
                                <input
                                    id="due_date"
                                    type="date"
                                    value={data.due_date}
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full rounded-lg border border-gray-300 px-4 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
                                />
                                <p className="mt-1 text-xs text-gray-400">Default 7 hari sebelum tanggal jatuh tempo.</p>
